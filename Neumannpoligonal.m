...
for k=1:nel        %recorrermos cada uno triangulos y calculamos para cada uno la mk y el vector local/nodos devuelve los tres vertices delelemento k 
	nodos=globales(k,:);          
...
%Resolvemos sistema
sol=a\b;
%for j = 1:nt        %para este nuevo no tenemos solución exacta
